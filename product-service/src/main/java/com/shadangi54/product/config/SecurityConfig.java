...
public class SecurityConfig {
    ...
    public JwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        grantedAuthoritiesConverter.setAuthorityPrefix(""); // Remove the prefix since the JWT already includes ROLE_
        grantedAuthoritiesConverter.setAuthoritiesClaimName("roles"); // Set the claim name to match the token
