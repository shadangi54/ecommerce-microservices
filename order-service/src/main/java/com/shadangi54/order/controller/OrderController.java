...
public class OrderController {
	...
	public ResponseEntity<List<OrderDTO>> getAllOrdersForCustomer(@PathVariable String customerName){
	...
	public ResponseEntity<OrderDTO> updateOrder(@PathVariable String orderNumber, @RequestParam String status) {
